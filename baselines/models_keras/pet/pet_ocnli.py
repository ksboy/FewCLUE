...
def load_data(filename):
    ...
    with open(filename, encoding='utf-8') as f:
        for jj,l in enumerate(f):
            ...
            label=json_string['label'] if 'label' in json_string else 'neutral'
...
# 加载数据集
train_data = load_data('../../../datasets/ocnli/train_0.json')
valid_data = load_data('../../../datasets/ocnli/dev_few_all.json')
...
if __name__ == '__main__':
    ...
    if training_type == "few-shot":
        ...
        val_data = load_data('../../../datasets/ocnli/dev_0.json')
        test_data = load_data('../../../datasets/ocnli/test.json')
